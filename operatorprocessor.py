    ...
    def expand_term(self, expr, possible_values):
        ...
        for arg in exp_arguments:
            if arg.is_Mul:
                ...
                if str(var) in possible_values:
                    terms_with_coeff[str(var)] = coeffs
            elif str(arg) in possible_values:
                terms_with_coeff[str(arg)] = 1  # If no coefficient is present, assume it is 1
